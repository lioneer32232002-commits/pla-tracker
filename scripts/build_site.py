...
info.onAdd=function(){
  ...
  var nc='text-align:right;padding-right:2px;white-space:nowrap;line-height:1.95';
  var lc='white-space:nowrap;line-height:1.95;padding-left:1px';
  var mlRow=ML>0
...
leg.onAdd=function(){
  ...
  d.innerHTML=
    ...
    '<line x1="0" y1="4" x2="18" y2="4" stroke="'+mlColor+'" stroke-width="'+(ML>0?2:1.5)+'" stroke-dasharray="'+(ML>0?'7,3':'6,4')+'"/></svg>中線</div>'+
    ...
    '<rect width="18" height="8" fill="url(#g12)" rx="1"/></svg>12海里領海</div>'+
    ...
    '<rect width="18" height="8" fill="url(#gac)" rx="1"/></svg>活動區域</div>':'');
  return d;
};
leg.addTo(map);
